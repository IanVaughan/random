...
class CD3DFramework7
{
    ...
    HRESULT CreateZBuffer( GUID*, DWORD );
    HRESULT CreateFullscreenBuffers( DDSURFACEDESC2*, DWORD );
    HRESULT CreateWindowedBuffers( DDSURFACEDESC2*, DWORD );
...
#define D3DFW_ZBUFFER       0x00000002 // Create and use a zbuffer
#define D3DFW_NO_FPUSETUP   0x00000004 // Don't use default DDSCL_FPUSETUP flag
