# Microsoft Developer Studio Project File - Name="test app1" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 5.00
# ** DO NOT EDIT **

# TARGTYPE "Java Virtual Machine Java Project" 0x0809

CFG=test app1 - Java Virtual Machine Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "test app1.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "test app1.mak" CFG="test app1 - Java Virtual Machine Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "test app1 - Java Virtual Machine Release" (based on\
 "Java Virtual Machine Java Project")
!MESSAGE "test app1 - Java Virtual Machine Debug" (based on\
 "Java Virtual Machine Java Project")
!MESSAGE 
...
!IF  "$(CFG)" == "test app1 - Java Virtual Machine Release"
...
!ELSEIF  "$(CFG)" == "test app1 - Java Virtual Machine Debug"
...
# Name "test app1 - Java Virtual Machine Release"
# Name "test app1 - Java Virtual Machine Debug"
